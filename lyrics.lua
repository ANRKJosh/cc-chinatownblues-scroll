...
local lyrics = {
  ...
  { text = "Tell me why, your lack of intuition", delay = 3.6 },
  { text = "burns me white", delay = 3.5 },
  { text = "Only you can make me burn just like the sun", delay = 7.6 },
  { text = "Only you can piece me back to one", delay = 7.0 },
  { text = "", delay = 1.0 },
  ...
  { text = "Let's see how far you'll push", delay = 2.5 },
  ...
  { text = "No matter what you do, I'll stay", delay = 3.2 },
  { text = "This isn't up to you today", delay = 3.0 },
  { text = "It hasn't always been this way", delay = 3.2 },
  { text = "I've got a lot to prove today", delay = 3.0 },
  { text = "", delay = 1.0 },
